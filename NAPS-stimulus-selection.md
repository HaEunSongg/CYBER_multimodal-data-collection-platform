...
| **Tutorial** | 3-step interactive practice (HADS item · BFI-2-S item · Plutchik Wheel · Russell grid) before data collection begins |
...
| `hads_[subscale]` | HADS subscale scores (Anxiety, Depression) |
| `hads_item_[n]_timestamp` | ISO 8601 timestamp per HADS item |
...
>
> Note: The HADS questionnaire is subject to copyright held by GL Assessment /
> the original authors and is not covered by this MIT License. Researchers
> should obtain appropriate permission for use in their own studies.
